...
public class CodingController {
    ...
    public ResponseEntity<ApiResponse<ProblemResponse>> generate(
        ...
        ProblemResponse problem =
                codingService.generateProblem(user.getId(), request);
    ...
    public ResponseEntity<ApiResponse<EvaluationResult>> evaluate(
        ...
        EvaluationResult result =
                codingService.evaluateSubmission(user.getId(), request);
    ...
    public ResponseEntity<ApiResponse<List<CodingAttempt>>> history(
            @AuthenticationPrincipal User user) {
    ...
    public ResponseEntity<ApiResponse<List<CodingAttempt>>> conceptHistory(
            @AuthenticationPrincipal User user,
