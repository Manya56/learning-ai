...
public class MentorService {
    ...
    public MentorChatResponse chat(UUID userId,
        ...
        String systemPrompt = buildSystemPrompt(
                personality, profile, userMessage);
    ...
    private String buildSystemPrompt(String personality,
        ...
        String languageRule = detectNonEnglish(userMessage)
    ...
    private String callGroqWithHistory(String systemPrompt,
        ...
        try {
            ...
            String languageInstruction = detectNonEnglish(newUserMessage)
            ...
            String finalUserMessage = """
                    ...
                    """.formatted(newUserMessage, languageInstruction);
